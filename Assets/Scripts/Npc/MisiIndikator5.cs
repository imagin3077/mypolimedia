...
public class MisiIndikator5 : MonoBehaviour
{
    private NPCMove dialog;
    ...
    private void Start()
    {
        dialog = GetComponent<NPCMove>();
        dialog.npcdibaca = PlayerPrefs.GetInt("npc");
